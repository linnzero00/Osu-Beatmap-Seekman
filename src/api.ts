...
export const api: Api = electronApi ?? (isTauri ? {
  ...
  exportCollectionPlaylist: (stableOsuDir, collectionName, selectedBeatmapIds) => invoke("export_collection_playlist", { stableOsuDir, collectionName, selectedBeatmapIds }),
