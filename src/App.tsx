...
export function App() {
  const [settings, setSettings] = useState({
    songsDir: "", lazerDir: "", osuClientId: "", osuClientSecret: "", bearerToken: "", concurrentDownloads: 8,
...
<label>并发下载<input type="number" min={1} max={64} value={settings.concurrentDownloads} onChange={(e) => updateSetting("concurrentDownloads", Number(e.target.value))} /></label>
        ...
        <section className="panel">
          ...
          <p className="hint">如果下载卡住，先把更流畅的镜像源移到最上方，再点击下载队列里的“一键重试”。</p>
        </section>
      </aside>
