...
src-tauri/target/release/bundle/nsis/Osu! Beatmap Seekman_2.0.2_x64-setup.exe
```
...
```text
Osu! Beatmap Seekman_2.0.2_x64-setup.exe
Osu! Beatmap Seekman_2.0.2_amd64.AppImage
Osu! Beatmap Seekman_2.0.2_amd64.deb
Osu! Beatmap Seekman_2.0.2_aarch64.dmg
app-universal-release-signed.apk
Osu-Beatmap-Seekman-2.0.2-source.zip
SHA256SUMS.txt
```
