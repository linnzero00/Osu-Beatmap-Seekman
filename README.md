...
src-tauri/target/release/bundle/nsis/Osu! Beatmap Seekman_2.0.3_x64-setup.exe
```
...
```text
Osu! Beatmap Seekman_2.0.3_x64-setup.exe
Osu! Beatmap Seekman_2.0.3_amd64.AppImage
Osu! Beatmap Seekman_2.0.3_amd64.deb
Osu! Beatmap Seekman_2.0.3_aarch64.dmg
app-universal-release-signed.apk
Osu-Beatmap-Seekman-2.0.3-source.zip
SHA256SUMS.txt
```
