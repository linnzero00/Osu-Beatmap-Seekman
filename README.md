...
src-tauri/target/release/bundle/nsis/Osu! Beatmap Seekman_1.0.2_x64-setup.exe
```
...
Osu-Beatmap-Seekman-1.0.2-portable.exe
Osu-Beatmap-Seekman-1.0.2-source.zip
SHA256SUMS.txt
```
