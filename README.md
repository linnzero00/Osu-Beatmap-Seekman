...
src-tauri/target/release/bundle/nsis/Osu! Beatmap Seekman_2.0.1_x64-setup.exe
```
...
```text
Osu! Beatmap Seekman_2.0.1_x64-setup.exe
Osu! Beatmap Seekman_2.0.1_amd64.AppImage
Osu! Beatmap Seekman_2.0.1_amd64.deb
Osu! Beatmap Seekman_2.0.1_aarch64.dmg
app-universal-release-signed.apk
Osu-Beatmap-Seekman-2.0.1-source.zip
SHA256SUMS.txt
```
